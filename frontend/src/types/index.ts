...
export interface DashboardData{user:User;overall:{confidence:number;performance:number;calibration_gap:number;mastery:number};assessments:Assessment[];gaps:Gap[];recommendation:string}
