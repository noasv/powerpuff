...
export interface Assessment{concept_id:number;concept_name:string;accuracy:number;average_confidence:number;recall_score:number;transfer_score:number;explanation_score:number;calibration_gap:number;concept_mastery:number;risk_level:string;updated_at:string}
